...
int main() {
    ...
    std::cout << "=====================================" << std::endl;
    std::cout << "Welcome to the Adventurer's Guild!"    << std::endl;
    std::cout << "Step up and have a look at the menu."  << std::endl;
    std::cout << "You can browse the full roster or"     << std::endl;
    std::cout << "view individual entries of heroes."    << std::endl;
    std::cout << "You can also view their weapons."      << std::endl;
    std::cout << std::endl;
